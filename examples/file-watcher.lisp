    ...
    (unwind-protect
         (let ((first-events nil)
           ...
           (with-watch (watcher file
             ...
             ;; the stream, and each wait outlasts the handler's tail: this
             ;; thread must not need a collection in either window.  gcd.lisp
             ;; says why, and why no collection is forced here.
