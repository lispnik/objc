...
(define-runtime-function ("objc_getClass" %objc-get-class) :pointer
  (name :string))

(define-runtime-function ("objc_getMetaClass" %objc-get-meta-class) :pointer
  (name :string))

(define-runtime-function ("objc_lookUpClass" %objc-look-up-class) :pointer
  (name :string))

(define-runtime-function ("class_getName" %class-get-name) :string
  (class :pointer))

(define-runtime-function ("class_getSuperclass" %class-get-superclass) :pointer
  (class :pointer))

(define-runtime-function ("class_isMetaClass" %class-is-meta-class) :boolean
  (class :pointer))

(define-runtime-function ("object_getClass" %object-get-class) :pointer
  (object :pointer))

(define-runtime-function ("objc_getClassList" %objc-get-class-list) :int
  (buffer :pointer)
  (count :int))

;;; Selectors ----------------------------------------------------------------

(define-runtime-function ("sel_registerName" %sel-register-name) :pointer
  (name :string))

(define-runtime-function ("sel_getName" %sel-get-name) :string
  (selector :pointer))

(define-runtime-function ("sel_isEqual" %sel-is-equal) :boolean
  (lhs :pointer)
  (rhs :pointer))

;;; Methods ------------------------------------------------------------------

(define-runtime-function ("class_getInstanceMethod" %class-get-instance-method) :pointer
  (class :pointer)
  (selector :pointer))

(define-runtime-function ("class_getClassMethod" %class-get-class-method) :pointer
  (class :pointer)
  (selector :pointer))

(define-runtime-function ("class_respondsToSelector" %class-responds-to-selector) :boolean
  (class :pointer)
  (selector :pointer))
...
(define-runtime-function ("method_getTypeEncoding" %method-get-type-encoding) :string
  (method :pointer))

(define-runtime-function ("method_getName" %method-get-name) :pointer
  (method :pointer))

(define-runtime-function ("method_getImplementation" %method-get-implementation) :pointer
  (method :pointer))

(define-runtime-function ("method_setImplementation" %method-set-implementation) :pointer
  (method :pointer)
  (imp :pointer))

(define-runtime-function ("method_getNumberOfArguments" %method-get-number-of-arguments) :unsigned-int
  (method :pointer))

(define-runtime-function ("class_copyMethodList" %class-copy-method-list) :pointer
  (class :pointer)
  (out-count :pointer))

;;; Building classes at runtime ----------------------------------------------

(define-runtime-function ("objc_allocateClassPair" %objc-allocate-class-pair) :pointer
  (superclass :pointer)
  (name :string)
  (extra-bytes :unsigned-long))

(define-runtime-function ("objc_registerClassPair" %objc-register-class-pair) :void
  (class :pointer))

(define-runtime-function ("objc_disposeClassPair" %objc-dispose-class-pair) :void
  (class :pointer))

(define-runtime-function ("class_addMethod" %class-add-method) :boolean
  (class :pointer)
  (selector :pointer)
  (imp :pointer)
  (types :string))

(define-runtime-function ("class_replaceMethod" %class-replace-method) :pointer
  (class :pointer)
  (selector :pointer)
  (imp :pointer)
  (types :string))
...
(define-runtime-function ("class_addIvar" %class-add-ivar) :boolean
  (class :pointer)
  (name :string)
  (size :unsigned-long)
  (alignment :uint8)
...
(define-runtime-function ("class_getInstanceVariable" %class-get-instance-variable) :pointer
  (class :pointer)
  (name :string))

(define-runtime-function ("class_copyIvarList" %class-copy-ivar-list) :pointer
  (class :pointer)
  (out-count :pointer))

(define-runtime-function ("ivar_getName" %ivar-get-name) :string
  (ivar :pointer))

(define-runtime-function ("ivar_getOffset" %ivar-get-offset) :long
  (ivar :pointer))

(define-runtime-function ("ivar_getTypeEncoding" %ivar-get-type-encoding) :string
  (ivar :pointer))

;;; Protocols ----------------------------------------------------------------

(define-runtime-function ("objc_getProtocol" %objc-get-protocol) :pointer
  (name :string))

(define-runtime-function ("class_addProtocol" %class-add-protocol) :boolean
  (class :pointer)
  (protocol :pointer))

(define-runtime-function ("class_conformsToProtocol" %class-conforms-to-protocol) :boolean
  (class :pointer)
  (protocol :pointer))

(define-runtime-function ("protocol_getName" %protocol-get-name) :string
  (protocol :pointer))
...
;;; tests.
(define-runtime-function ("NSGetSizeAndAlignment" %ns-get-size-and-alignment) :pointer
  (type-encoding :string)
  (size-out :pointer)
  (alignment-out :pointer))

(define-runtime-function ("free" %free) :void
  (pointer :pointer))
